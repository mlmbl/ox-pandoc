...
This is an incompatible change that alters output from exisiting
...
version of =ox-pandoc= with numbering is *v1.2023*, from January 2023.
No fixes or features will be ported to this version.
